...
const Dashboard = () => {
  ...
  pulseClass: '',
    ...
    },
    {
      ...
      pulseClass: '',
      bgGradient: dashboardData.overduePayments > 0 ? 'bg-gradient-to-br from-red-50 to-red-100' : 'bg-gradient-to-br from-orange-50 to-orange-100',
      iconBg: dashboardData.overduePayments > 0 ? 'bg-red-100' : 'bg-orange-100'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      <div className="w-full px-2 sm:px-4 lg:px-6 py-3 sm:py-6 space-y-4 sm:space-y-6">
        {/* Welcome Section */}
        ...
        {/* Quick Actions */}
        <div className="bg-white rounded-xl shadow-lg border-0 p-4 sm:p-6 backdrop-blur-sm bg-white/90">
          ...
          <div className="grid gap-3 sm:gap-4 grid-cols-2 lg:grid-cols-4">
            <Card className="bg-gradient-to-br from-yellow-50 to-yellow-100 border-yellow-200">
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm font-medium text-yellow-800">Pending Orders</p>
            ...
            <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm font-medium text-blue-800">In Progress</p>
            ...
            <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200">
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm font-medium text-green-800">Ready for Delivery</p>
            ...
            <Card className="bg-gradient-to-br from-red-50 to-red-100 border-red-200">
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm font-medium text-red-800">Overdue</p>
